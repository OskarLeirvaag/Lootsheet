...
func ShellDataToProto(d *model.ShellData) *ShellDataProto {
	return &ShellDataProto{
		...
		SettingsCampaigns:    listScreenDataToProto(&d.SettingsCampaigns),
		...
		SettingsCompendium:   listScreenDataToProto(&d.SettingsCompendium),
		CompendiumMonsters:   listScreenDataToProto(&d.CompendiumMonsters),
		CompendiumSpells:     listScreenDataToProto(&d.CompendiumSpells),
		CompendiumItems:      listScreenDataToProto(&d.CompendiumItems),
		CompendiumRules:      listScreenDataToProto(&d.CompendiumRules),
		CompendiumConditions: listScreenDataToProto(&d.CompendiumConditions),
	}
}
...
func ShellDataFromProto(p *ShellDataProto) model.ShellData {
	...
	return model.ShellData{
		...
		SettingsCampaigns:    listScreenDataFromProto(p.SettingsCampaigns),
		...
		SettingsCompendium:   listScreenDataFromProto(p.SettingsCompendium),
		CompendiumMonsters:   listScreenDataFromProto(p.CompendiumMonsters),
		CompendiumSpells:     listScreenDataFromProto(p.CompendiumSpells),
		CompendiumItems:      listScreenDataFromProto(p.CompendiumItems),
		CompendiumRules:      listScreenDataFromProto(p.CompendiumRules),
		CompendiumConditions: listScreenDataFromProto(p.CompendiumConditions),
	}
}
