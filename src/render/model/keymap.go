...
func DefaultKeyMap() KeyMap {
	return KeyMap{
		Bindings: []Binding{
			...
			{Action: ActionShowDashboard, Stroke: KeyStroke{Key: tcell.KeyRune, Rune: '1'}, Label: "1-8 jump"},
			{Action: ActionShowLedger, Stroke: KeyStroke{Key: tcell.KeyRune, Rune: '2'}},
			{Action: ActionShowJournal, Stroke: KeyStroke{Key: tcell.KeyRune, Rune: '3'}},
			{Action: ActionShowQuests, Stroke: KeyStroke{Key: tcell.KeyRune, Rune: '4'}},
			{Action: ActionShowLoot, Stroke: KeyStroke{Key: tcell.KeyRune, Rune: '5'}},
			{Action: ActionShowAssets, Stroke: KeyStroke{Key: tcell.KeyRune, Rune: '6'}},
			{Action: ActionShowCodex, Stroke: KeyStroke{Key: tcell.KeyRune, Rune: '7'}},
			{Action: ActionShowNotes, Stroke: KeyStroke{Key: tcell.KeyRune, Rune: '8'}},
