...
Generated CLI man pages are checked in under [docs/man/](/home/raknoel/Projects/Private/Lootsheet/docs/man) and can be refreshed with:
...
The repository now includes a reusable sample campaign fixture at [fixtures/sample_campaign.sql](/home/raknoel/Projects/Private/Lootsheet/fixtures/sample_campaign.sql).
...
The current supported database upgrade and recovery workflow is documented in [docs/upgrade-recovery.md](/home/raknoel/Projects/Private/Lootsheet/docs/upgrade-recovery.md).
