...
- tracking loot before it is sold
...
LootSheet is currently used through:

- a CLI for explicit command-driven workflows
- a full-screen TUI for browsing and common actions
